        ...
        <div class="category-tab">
            <div class="container-fluid">
                <ul id="category-tab_top" class="nav nav-tabs" role="tablist">
                    ...
                    ?>
                    <li role="presentation" class="<?php if ($l == 0) { echo 'active'; } ?>">
                            <a href="#category-tab-<?php echo $l; ?>" aria-controls="category-tab-<?php echo $l; ?>"
                               role="tab"
            ...
            <div class="tab-content wrap-project-content">
                ...
                $j = 0;
                foreach ($categories as $key => $value) { ?>
                <div role="tabpanel" class="tab-pane in <?php if ($j == 0) { echo 'active'; } ?>" id="category-tab-<?php echo $j; ?>">
                    <div class="container container--mod">
                        <div class="row">
                            <?php
                            $query = new WP_Query(
