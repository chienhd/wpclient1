...
<main id="introduce">
    ...
    <section id="gt1" class="section-nd">
        <div class="container">
            ...
            NỘI THẤT CAO CẤP AHOME        </h2>
                    <p>Được xây dựng trên nền tảng của sự sáng tạo, Ahome luôn&nbsp;không ngừng cố gắng, nỗ lực để giữ vững vị thế tiên phong của mình trên thị trường nội thất cao cấp tại Việt Nam hiện nay.</p>
                    <p>Chúng tôi lấy tên “Ahome” với ý nghĩa&nbsp;sâu sắc về sự tiên phong, đi đầu trong mọi xu hướng cũng như mọi sự vận động của nhóm ngành thiết kế, thi công nội thất.</p>
                    <p>Chữ “A” là con chữ đầu tiên của bảng chữ cái, cũng là mức cao nhất trong thang điểm khi chúng ta đánh giá một vấn đề gì đó, chữ “A” là biểu tượng cho vị trí thứ nhất trong mọi câu chuyện. Cái tên “Ahome” được lựa chọn với mục đích mang đến cho các gia đình những không gian sống sang trọng nhất, đẳng cấp nhất, khác biệt nhất và ấn tượng nhất.</p>
                    <hr>
                </div>
                <div class="col-xs-12 col-md-6">
                    <img src="https://noithatahome.vn/wp-content/uploads/web800-1.jpg" alt="NỘI THẤT CAO CẤP AHOME">
    ...
    <section id="gt2" class="section-nd" style="background: url(https://noithatahome.vn/wp-content/uploads/2018/04/img_background.jpg) center;">
        <div class="container">
            <div class="row row-40">
                <div class="col-xs-12 col-md-4 col-title">
                    <h2 class="title-section text-uppercase">TẦM NHÌN VÀ SỨ MỆNH</h2>
                    <div class="number">02</div>
                </div>
                <div class="col-xs-12 col-md-8 col-content text-justify">
                    <p>Để xứng đáng với sự tín nhiệm và niềm tin của quý vị, Ahome sẽ định hướng qua các dự án thiết kế, thi công nổi bật cùng những xu hướng mới nhất trên thế giới. Và muốn hoàn thành nhiệm vụ cao cả ấy, chính chúng tôi sẽ phải là những người đi đầu trong việc xây dựng những “chuẩn mực” trong quá trình hoạt động.</p>
                    <p>Ngay từ khi bắt đầu, chúng tôi đã mang trên mình sứ mệnh cao cả đó là tạo nên những giá trị sống đặc biệt cho từng gia đình, và hơn bất cứ điều gì đó chính là không gian nội thất. Chúng tôi cam kết mang đến cho quý vị những công trình sang trọng, hiện đại, “chất” và hoàn toàn khác biệt.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row row-40">
                <div class="col-xs-12 col-md-8 col-content text-justify">
                    ...
                    <ul>
                        ...
                        <li>Chế độ bảo hành, bảo trì uy tín, tin cậy cho mọi sản phẩm</li>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-5">
                    ...
                    <div class="text-justify clear">
                        ...
                        <p>Một lần nữa, Ahome luôn khẳng định vị thế tiên phong vững chắc của mình trên thị trường nội thất Việt. Chúng tôi đã nhận được rất nhiều sự quan tâm, tin tưởng và lựa chọn của khách hàng cũng như sự đánh giá cao về chất lượng của các chuyên gia trong nghề, tự tin trở thành địa chỉ tin cậy cho các không gian sống tối thượng của quý vị.</p>
                    </div>
                </div>
            </div>
        </div>
